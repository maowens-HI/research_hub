...
::: {.page-header}
# School Finance Research Repository {.page-title}

Partial replication and extension of Jackson, Johnson, and Persico (2016)
:::

::: {style="text-align: center; margin: 2rem 0;"}
[View on GitHub](https://github.com/maowens-HI/school_finance){.btn .btn-primary target="_blank" style="padding: 0.75rem 1.5rem; background-color: #1E3A5F; border: none; border-radius: 6px; color: white; text-decoration: none; font-weight: 600; display: inline-block;"}
:::
