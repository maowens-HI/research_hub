...
**Topic:** Comparing good counties only versus good and bad counties for Fig 1 and event study estimates by quartile for Fig 2.

::: {.callout-note appearance="minimal"}
**Analysis Components:**

- **Good vs Good and Bad Counties**: Fig 1 estimates using 1971 baseline spending quartiles comparing good counties only versus good and bad counties
- **Summary Statistics**: Comparison of baseline spending, income, region, and population between good and bad counties
- **Quartile-Specific Figure 2**: Six specifications showing event study estimates with four lines (one per quartile of predicted spending)
...
**Topic:** Comparing baseline (no jackknife) and jackknife approaches across three specifications.
...
**Topic:** Updated Figure 2 plus some notes on fixes.
