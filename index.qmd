...
[Comparing good vs all counties and event study estimates by quartile]{.card-excerpt}
...
**Topic:** Comparing good vs all counties for Fig 1 and event study estimates by quartile for Fig 2.

::: {.callout-note appearance="minimal"}
**Analysis Components:**

- **Good vs All Counties**: Fig 1 estimates using 1971 baseline spending quartiles comparing good counties only versus all counties
