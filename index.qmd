...
[Documenting progress, sharing findings, and tracking methodological decisions for our ongoing project collaboration.]{.hero-tagline}

::: {.hero-features}
::: {.hero-feature}
**25+** Research Analyses
:::
::: {.hero-feature}
**8 Months** Active Development
:::
::: {.hero-feature}
**Live** Collaboration
:::
...
::: {.carousel-slide}
::: {.research-card}
[Working Paper]{.card-category}

[Figure 2 Fixes & Jackknife Strategy]{.card-title}

[Resolving the "Never Treated" interaction issue in regression analysis. Bug found and fixed: "High" variable was defined as missing for never-treated units.]{.card-excerpt}

[December 2025]{.card-meta}

[View Analysis](https://maowens.quarto.pub/jk_code_review/){.card-link}
:::
:::
...
[Robustness & JJP Comparison]{.card-title}

[Jackknife vs Non-Jackknife and Sample Selection Bias analysis. Comparing Figure 1 among bottom 10% baseline spending counties.]{.card-excerpt}

[November 2025]{.card-meta}

[View Analysis](https://maowens.quarto.pub/jackknife/){.card-link}
:::
:::
...
[District & Panel Analysis]{.card-title}

[District level expansion and balancing checks. Sample balanced on non-missing spending data from event times -5 to 17.]{.card-excerpt}

[November 2025]{.card-meta}

[View Results](https://maowens.quarto.pub/district_and_top_100/){.card-link}
:::
:::
...
[Balanced Panel Results]{.card-title}

[Sample balanced on non-missing spending from event times -5 to 17, analyzing the effects at district level with aggregation considerations.]{.card-excerpt}

[November 2025]{.card-meta}

[View Results](https://maowens.quarto.pub/balanced-panel-event-study-analysis/){.card-link}
:::
:::

::: {.carousel-slide}
::: {.research-card}
[Robustness]{.card-category}

[Sample Variations Study]{.card-title}

[Comprehensive robustness checks across weighted/unweighted samples and various sample restrictions including tract area analysis.]{.card-excerpt}

[November 2025]{.card-meta}

[View Results](https://maowens.quarto.pub/11_7_25_wt/){.card-link}
:::
:::

::: {.carousel-slide}
::: {.research-card}
[Methodology]{.card-category}

[The "Mixed" County Problem]{.card-title}

[Addressing counties with multiple non-tracted areas by combining into pseudo-areas and using residual county population for weighting.]{.card-excerpt}

[October 2025]{.card-meta}

[View Details](#oct-31-the-mixed-county-problem){.card-link}
:::
:::
...
::: {.mission-block}
[This hub organizes my research work for your review—tracking analyses, documenting methodological decisions, and maintaining a transparent record of our project's evolution. Think of it as a living research notebook that makes our collaboration more efficient.]{.mission-text}

[Learn About This Project](about.qmd){.cta-secondary}
:::
...
::: {.section-header}
## Quick Access
Links to our shared workspace and meeting notes.
:::
