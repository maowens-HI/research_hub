...
# Advancing Sound Economic Policy for the 21st Century {.hero-headline}

[Rigorous research. Real-world impact. Transparent insight.]{.hero-tagline}

[Explore Research](#latest-research){.cta-primary}
...
Recent working papers, analyses, and policy briefs from our team.
:::
...
::: {.mission-block}
[The Research Hub produces rigorous, transparent research on education finance and economic policy. Our work advances academic discourse, informs policymakers, and serves the public interest through open data and reproducible analysis.]{.mission-text}

[Learn About Us](about.qmd){.cta-secondary}
:::
...
Key links for collaboration and data access.
:::
...
Synchronized notes and agenda for team coordination.
