...
[Dec 05: JK Instability - Classification Issues]{.card-title}

[Investigation reveals Ohio and Texas counties misclassified in jackknife procedure due to below-average spending growth. 840 observations contaminate "high predicted" group, compressing event-study results.]{.card-excerpt}
...
**Key Finding:** Two states (Ohio and Texas) have below-average spending growth for their high-baseline-spending counties, causing them to be misclassified as "high predicted" in the jackknife procedure.

**Impact:** 840 observations (11.9% of the "high" group) contaminate the jackknife results, compressing the event-study trends.

**Root Cause:** Leave-one-state-out predictions diverge from actual outcomes when states are highly influential. Ohio pre_q 4 and Texas pre_q 3 counties are classified as "high predicted" based on other states' patterns despite their below-average performance.
:::
